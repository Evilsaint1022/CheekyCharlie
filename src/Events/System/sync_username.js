...
module.exports = {
  ...
  async execute(oldUser, newUser, client) {
    ...
    const excludedDatabases = ['starboard', 'starboardids', 'staff_app_questions', 'staff_app_applications','giveaways', 'giveaway_participants', 'giveaway_settings', 'specials', 'qotd', 'ai_deadchat'];
