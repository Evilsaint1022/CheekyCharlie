...
const db = {
    ...
    status_channel: new DotDB("./src/Utilities/Storage/Settings/StatusChannel/statuschannel.json"),
    stickyMessages: new DotDB("./src/Utilities/Storage/Settings/StickyMessages/stickymessages.json"),
    ...
    punchgifs: new DotDB("./src/Utilities/Storage/Fallback/punchgifs.json"),
