...
module.exports = {
  ...
  async execute(interaction) {
    ...
    //console logs 
    console.log(`[🌿] [COUNTING] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${interaction.guild.name} ${interaction.guild.id} ${interaction.user.username} used the counting command.`);
