...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            // Console Logs
            console.log(`[🌿] [LOCK-VC] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} used the lock-vc command.`);
