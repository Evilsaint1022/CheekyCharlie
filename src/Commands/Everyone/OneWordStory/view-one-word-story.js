...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(`[🌿] [VIEW-ONE-WORD-STORY] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${interaction.guild.name} ${interaction.guild.id} ${interaction.user.username} used the view-one-word-story command.`);
