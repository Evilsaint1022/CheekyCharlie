...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            // Console Log
            console.log(`[🌿] [INVITE] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ", { timeZone: "Pacific/Auckland" })}] ${guild.name} ${guild.id} ${user.username} used the invite command.`);
