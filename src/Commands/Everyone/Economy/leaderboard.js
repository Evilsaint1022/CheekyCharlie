...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(`[🌿] [LEADERBOARD] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${interaction.guild.name} ${interaction.guild.id} ${interaction.user.username} used the leaderboard command for '${type}'.`);
