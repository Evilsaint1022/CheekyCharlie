...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[DAILY] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guild.name} ${guild.id} ${username} used the daily command and got ${rewardAmount} Ferns.`);
    }
};
