...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const generateEmbed = (page) => {
      ...
      console.log(`[🌿] [SHOP] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${guild.name} ${guild.id} ${interaction.user.username} used the shop command.`);
      return embed;
    };
