...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(`[🌿] [INVENTORY] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${guild.name} ${guild.id} ${interaction.user.username} used the inventory command.`);
