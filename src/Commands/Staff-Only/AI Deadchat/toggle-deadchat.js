...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[⭐] [TOGGLE-DEADCHAT] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString("en-NZ")}] ${guildName} ${guildId} ${interaction.user.username} used the toggle deadchat command.`);
