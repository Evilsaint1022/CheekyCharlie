...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[⭐] [SET-DEADCHAT-CHANNEL] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString("en-NZ")}] ${guildName} ${guildId} ${interaction.user.tag} used the set-deadchat-channel command to set the channel ID "${channel.id}"`);
