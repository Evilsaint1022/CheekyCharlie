...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Console logs
        console.log(`[⭐] [RMOVE-STORY-CHANNEL] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${guildName} ${guildId} ${interaction.user.username} used the remove-story-channel command.`);
    }
};