...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      console.log(`[⭐] [SET-LEVEL-ROLE] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${guild.name} ${guild.id} ${interaction.user.tag} Set level ${level} role to ${role.id}`);
