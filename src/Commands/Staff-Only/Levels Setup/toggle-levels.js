...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(`[⭐] [TOGGLE-LEVELS] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.tag} used the toggle levels command.`);
