...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      console.log(`[⭐] [REMOVE-LEVEL-ROLE] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${interaction.user.tag} removed role <@&${removedRoleId}> from level ${level}.`);
