...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[⭐] [REMOVE-IGNORE-AI-CHANNEL] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${username} Removed channel / category <#${channel.id}> from the ignored AI channels list.`);
