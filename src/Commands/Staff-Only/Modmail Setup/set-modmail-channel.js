...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (guildId === "1365657523088134234" || guildId === "1346955021614317619") {
            ...
            console.log(`[⭐] [SET-MODMAIL] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${guildName}_${guildId} ${interaction.user.tag} used the set-modmail-channel command to set the channel ID "${channel.id}"`);
