...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[⭐] [SET-PARTYDROP-CHANNEL] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${guildName} ${guildId} ${interaction.user.tag} set the drop party channel to "${channel.id}"`);
