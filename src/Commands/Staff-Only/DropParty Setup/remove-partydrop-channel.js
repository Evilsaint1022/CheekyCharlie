...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[REMOVE-DROPPARTY-CHANNEL] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.tag} removed the drop party channel.`);
