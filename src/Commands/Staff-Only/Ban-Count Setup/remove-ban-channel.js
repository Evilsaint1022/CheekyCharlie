...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      console.log(`[REMOVE-BAN-CHANNEL] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${username} removed ${currentSettings.ban_channel} from the ban channel.`);
