...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Console Logs
        console.log(`[ECHO] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.tag} used the echo command. Message: ${messageContent}`);
