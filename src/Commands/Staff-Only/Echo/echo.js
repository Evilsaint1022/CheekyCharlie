...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Console Logs
        console.log(`[⭐] [ECHO] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.tag} used the echo command. Message: ${messageContent}`);
