...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      //console logs
      console.log(`[SET-BUMP-CHANNEL] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} used the set-bump-channel command.`);
