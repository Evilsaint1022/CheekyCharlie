...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      console.log(`[SET-BUMP-ROLE] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} used the set-bump-role command.`);
