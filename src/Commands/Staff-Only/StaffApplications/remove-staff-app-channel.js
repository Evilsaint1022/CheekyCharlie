...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[⭐] [REMOVE-STAFF-APP-CHANNEL] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} removed staff application channel`);
