...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`[${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} declined staff application for user ${application.userId}. Reason: ${reason}`);
