...
async function handleAddFlow(interaction, questionsKey, response) {
    ...
    console.log(`[MANAGE-STAFF-APPS-QUESTIONS] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} added staff application question: ${questionText}`);
...
async function handleMoveFlow(interaction, questionsKey, response) {
    ...
    if (interaction.isStringSelectMenu()) {
        ...
        console.log(`[MANAGE-STAFF-APPS-QUESTIONS] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} moved question ${questionNumber} ${direction}`);
...
async function handleRemoveSelect(interaction, questionsKey, response) {
    ...
    console.log(`[MANAGE-STAFF-APPS-QUESTIONS] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} removed staff application question: ${removedQuestion.question}`);
