...
module.exports = {
  ...
  async execute(interaction) {
    ...
    //console logs
    console.log(`[⭐] [EDIT-SHOP-ITEM] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${guild.name} ${guild.id} ${user.username} used the edit-shop-item command.`);
