...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      //console logs
      console.log(`[⭐] [ADD-SHOP-ITEM] [${new Date().toLocaleDateString('en-GB')}] [${new Date().toLocaleTimeString("en-NZ")}] ${interaction.guild.name} ${interaction.guild.id} ${interaction.user.username} used the add-shop-item command.`);
