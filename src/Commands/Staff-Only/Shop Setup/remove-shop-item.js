...
module.exports = {
  ...
  async execute(interaction) {
    ...
    //console logs
    console.log(`[REMOVE-SHOP-ITEM] [${new Date().toLocaleDateString()}] [${new Date().toLocaleTimeString()}] ${guildName} ${guildId} ${interaction.user.username} used the remove-shop-item command.`);
